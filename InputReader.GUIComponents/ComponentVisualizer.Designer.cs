namespace InputResender.GUIComponents {
	partial class ComponentVisualizer {
		/// <summary>
		...
		private void InitializeComponent () {
			...
			ShortcutWorkerLabel = new System.Windows.Forms.Label ();
			...
			ShortcutWorkerGenericInfo = new System.Windows.Forms.Label ();
			CommandWorkerGenericInfo = new System.Windows.Forms.Label ();
			InputReaderGenericInfo = new System.Windows.Forms.Label ();
			LowLevelInputGenericInfo = new System.Windows.Forms.Label ();
			EventVectorGenericInfo = new System.Windows.Forms.Label ();
			ElapsedTimeLabel = new System.Windows.Forms.Label ();
			SuspendLayout ();
			// 
			...
			MainAppControlsLabel.Text = "MainAppControls";
			// 
			// InputSimulatorLabel
			// 
			...
			InputSimulatorLabel.Text = "InputSimulator";
			// 
			// CommandWorkerLabel
			// 
			...
			CommandWorkerLabel.Size = new System.Drawing.Size ( 133, 20 );
			CommandWorkerLabel.TabIndex = 31;
			CommandWorkerLabel.Text = "CommandWorker";
			// 
			// ShortcutWorkerLabel
			// 
			...
			ShortcutWorkerLabel.Text = "ShortcutWorker";
			// 
			// PacketSenderLabel
			// 
			...
			PacketSenderLabel.Text = "PacketSender";
			// 
			// DataSignerLabel
			// 
			...
			DataSignerLabel.Text = "DataSigner";
			// 
			// InputProcessorLabel
			// 
			...
			InputReaderLabel.Size = new System.Drawing.Size ( 96, 20 );
			InputReaderLabel.TabIndex = 25;
			InputReaderLabel.Text = "InputReader";
			// 
			// LowLevelInputLabel
			// 
			...
			LowLevelInputLabel.Size = new System.Drawing.Size ( 112, 20 );
			LowLevelInputLabel.TabIndex = 24;
			LowLevelInputLabel.Text = "LowLevelInput";
			// 
			// EventVectorLabel
			// 
			...
			EventVectorLabel.Text = "EventVector";
			// 
			...
			InputSimulatorGenericInfo.Text = "Version: 0\r\nCreation time: 0-00-00\r\nName: #asdf\r\nVariant: VComponentMock";
			// 
			...
			InputProcessorGenericInfo.Text = "Version: 0\r\nCreation time: 0-00-00\r\nName: #asdf\r\nVariant: VComponentMock";
			// 
			...
			DataSignerGenericInfo.Text = "Version: 0\r\nCreation time: 0-00-00\r\nName: #asdf\r\nVariant: VComponentMock";
			// 
			...
			PacketSenderGenericInfo.Text = "Version: 0\r\nCreation time: 0-00-00\r\nName: #asdf\r\nVariant: VComponentMock";
			// 
			...
			ShortcutWorkerGenericInfo.Text = "Version: 0\r\nCreation time: 0-00-00\r\nName: #asdf\r\nVariant: VComponentMock";
			// 
			...
			CommandWorkerGenericInfo.Text = "Version: 0\r\nCreation time: 0-00-00\r\nName: #asdf\r\nVariant: VComponentMock";
			// 
			...
			LowLevelInputGenericInfo.Text = "Version: 0\r\nCreation time: 0-00-00\r\nName: #asdf\r\nVariant: VComponentMock";
			// 
			...
			EventVectorGenericInfo.Text = "Version: 0\r\nCreation time: 0-00-00\r\nName: #asdf\r\nVariant: VComponentMock";
			// 
			// ElapsedTimeLabel
			// 
			ElapsedTimeLabel.AutoSize = true;
			ElapsedTimeLabel.Location = new System.Drawing.Point ( 12, 18 );
			ElapsedTimeLabel.Name = "ElapsedTimeLabel";
			ElapsedTimeLabel.Size = new System.Drawing.Size ( 38, 15 );
			ElapsedTimeLabel.TabIndex = 33;
			ElapsedTimeLabel.Text = "label1";
			// 
			// ComponentVisualizer
			// 
			...
			Controls.Add ( CommandWorkerLabel );
			Controls.Add ( ShortcutWorkerLabel );
			...
			Controls.Add ( ShortcutWorkerGenericInfo );
			Controls.Add ( CommandWorkerGenericInfo );
			Controls.Add ( LowLevelInputGenericInfo );
			Controls.Add ( EventVectorGenericInfo );
			Name = "ComponentVisualizer";
			Text = "ComponentVisualizer";
			FormClosing += ComponentVisualizer_FormClosing;
			Load += ComponentVisualizer_Load;
			ResumeLayout ( false );
			PerformLayout ();
		}
		...
		private System.Windows.Forms.Label MainAppControlsLabel;
		private System.Windows.Forms.Label InputSimulatorLabel;
		private System.Windows.Forms.Label CommandWorkerLabel;
		private System.Windows.Forms.Label ShortcutWorkerLabel;
		...
		private System.Windows.Forms.Label MainAppControlsGenericInfo;
		...
		private System.Windows.Forms.Label ShortcutWorkerGenericInfo;
		private System.Windows.Forms.Label CommandWorkerGenericInfo;
		private System.Windows.Forms.Label EventVectorGenericInfo;
